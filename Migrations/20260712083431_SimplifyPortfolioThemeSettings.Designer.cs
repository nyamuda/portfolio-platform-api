...
namespace PortfolioPlatform.Api.Migrations
{
    ...
    [Migration("20260712083431_SimplifyPortfolioThemeSettings")]
    partial class SimplifyPortfolioThemeSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OfferingTag", b =>
                {
                    ...
                    b.ToTable("OfferingTags", (string)null);
                });
            ...
            modelBuilder.Entity("PortfolioPlatform.Api.Models.Content.BlogPost", b =>
                {
                    ...
                    b.HasOne("PortfolioPlatform.Api.Models.Content.Topic", "Topic")
                        .WithMany("BlogPosts")
